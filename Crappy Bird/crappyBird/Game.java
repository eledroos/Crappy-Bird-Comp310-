...
public class Game extends JPanel{
	...
	Birds birdy = new Birds();						//makes a new bird 
	...
	static String deathMessage = "" ; 				// "He's Dead Jim!";
	
	//grabs the background from URL
	BufferedImage img = null;{
	try {
		img = ImageIO.read(new URL("https://dl.dropboxusercontent.com/u/25535461/CrapBird/lojmr.jpg"));
	} catch (IOException e) {
	...
	public void move(){
		...
		if ( (wall.x == Birds.X) || (wall2.x == Birds.X) ) 	//Increments the score when the player passes a wall
			score();
	}
